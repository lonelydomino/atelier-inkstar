...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Control never looked this collectible. Spicy-coded premium vinyl sticker with rich color and a durable laminate coat.",
    category: "spicy",
    spicy: true,
    available: true,
    collections: ["treasure", "chainsaw-man", "spicy"],
  },
  {
    id: "nami-robin",
